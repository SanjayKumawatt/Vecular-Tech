...
import DedicatedServerFormFAQ from '../Components/DedicatedServerFormFAQ';
          ...
          <div className="max-w-3xl text-left">
            ...
            <ul className="mt-8 space-y-3 text-base text-slate-300">
              <li className="flex items-center gap-3">
                ...
                <span>Full control. One machine. All yours. No shared resources, ever</span>
              </li>
              <li className="flex items-center gap-3">
                <CheckCircle2 className="h-5 w-5 text-sky-400 flex-shrink-0" />
                <span>Flexible storage and RAM options to match your needs</span>
              </li>
              <li className="flex items-center gap-3">
                <CheckCircle2 className="h-5 w-5 text-sky-400 flex-shrink-0" />
                <span>24/7 support. Need help? We're always online</span>
              </li>
            </ul>
