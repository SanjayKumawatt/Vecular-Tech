...
const RegisterIn = () => {
  // .in specific pricing data (based on your pricing page)
  const inPricing = {
    register: '₹899',
    transfer: '₹899',
    renew: '₹899',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto">
            <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl">
              Register Your .in Domain
            </h1>
            <p className="mt-4 text-xl text-gray-600">
              The domain of India, for businesses and individuals in India.
            </p>
          </div>
          ...
          <div className="mt-12 max-w-3xl mx-auto">
            <form className="flex flex-col sm:flex-row gap-4 p-2 border border-gray-200 rounded-lg shadow-sm bg-white focus-within:ring-2 focus-within:ring-sky-500">
              <div className="flex-grow flex items-center">
                ...
                <input
                  type="text"
                  placeholder="Find your perfect .in domain..."
