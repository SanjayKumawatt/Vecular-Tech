        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl text-left">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Fast, reliable, secure website hosting in India
            </h1>
            
            {/* Paragraph */}
            <p className="mt-6 max-w-2xl text-lg text-slate-300">
              Enjoy fast, secure, and scalable web hosting with Indian servers, LiteSpeed
              performance, built-in automated backups, free migration, and a unified control
              panel designed for flexibility and growth.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row sm:items-center gap-6">
              <Link
                to="/domains/pricing" // Aap ise hosting-specific plans page par link kar sakte hain
