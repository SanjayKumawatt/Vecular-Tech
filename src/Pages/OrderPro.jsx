// src/pages/OrderPro.jsx
import React from 'react';
import { Link, useSearchParams } from 'react-router-dom'; // <-- Imports
import { CheckCircle2 } from 'lucide-react';

// Poora pricing data "Pro" plan ke liye
const planData = {
  name: 'Pro Plan',
  features: [
    'Unlimited Websites', '75 GB NVMe Disk Space', '4 vCPU and 8GB RAM',
    'Unlimited Email Accounts', 'Unlimited Subdomains', 'Unlimited MySQL Databases',
    'Unlimited Bandwidth', 'Free SSL Certificate', 'Daily Backups', 'LiteSpeed Webserver',
  ],
  pricing: {
    monthly: {
      price: '₹799', suffix: '/month',
