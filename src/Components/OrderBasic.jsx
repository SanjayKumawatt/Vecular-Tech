...
const planData = {
  name: 'Basic Plan',
  features: [
    '1 Website', '15 GB NVMe Disk Space', '1 vCPU and 2GB RAM',
    '10 Email Accounts', 'Unlimited Subdomains', 'Unlimited MySQL Databases',
...
// Helper function jo URL se price select karega
const getPlanDetails = (cycleParam) => {
  if (cycleParam === 'monthly') {
    return planData.pricing.monthly;
  }
  if (cycleParam === 'annually') {
    return planData.pricing.annually;
  }
  // Default hamesha triennially rakho
  return planData.pricing.triennially;
};
        ...
        <div className="mt-12 bg-white border border-gray-200 rounded-lg shadow-sm">
          <div className="p-6">
            ...
            <p className="mt-4 text-lg text-gray-600">
              You are about to order the <span className="font-bold">{planData.name}</span> plan.
            </p>
